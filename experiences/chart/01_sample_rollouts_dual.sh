...
export HF_DATASETS_CACHE="${HF_DATASETS_CACHE:-/data4/FTSO/datasets/gsm/hf_datasets}"
export HF_HOME="${HF_HOME:-/data4/FTSO/datasets/gsm/hf_datasets}"

SCRIPTS="$VCTS/lzl/experiences/chart"
TRAIN_JSONL="/data4/FTSO/datasets/chart/processed/chart/chartqa_train.jsonl"
ROLLOUTS="/data4/FTSO/datasets/chart/processed/chart/rollouts/chartqa_train_g32.jsonl"
SHARD_DIR="/data4/FTSO/datasets/chart/processed/chart/rollouts/shards"
