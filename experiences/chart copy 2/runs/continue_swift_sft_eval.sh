...
CONFIG="${CONFIG:-$HERE/configs/config_qwen35.yaml}"
...
MODEL="${MODEL:-/data5/lzl/models/Qwen3.5-4B}"
CKPT_ROOT="${CKPT_ROOT:-/data5/lzl/checkpoints/chart_qwen35_full}"
DATA_ROOT="${DATA_ROOT:-$LZL_ROOT/data/chart_qwen35/sft}"
