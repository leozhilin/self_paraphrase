# WARNING: 05_sft_train.py task-branch auto-rewrite failed; please manually replace the task-dispatch in main() with hard-coded GSM block.
#!/usr/bin/env python3
...
add_vcts_to_syspath()
from utils import ANSWER_FORMAT_HINT  # noqa: E402
