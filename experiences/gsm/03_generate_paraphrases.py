#!/usr/bin/env python3
"""Step 3 (gsm, vllm): vLLM-based paraphrase generator.
...
from utils import PARAPHRASE_GSM_PROMPT as PARAPHRASE_PROMPT
# answer extraction & matching come from the shared sampling helper.
from paths import add_vcts_to_syspath
add_vcts_to_syspath()
from sampling.sample_rollouts import (  # noqa: E402
    answers_match as gsm_answers_match,
    extract_model_answer as gsm_extract,
)
extract_answer = gsm_extract
answers_match = gsm_answers_match
USE_VISION = False
...
def main():
    ...
    print(f"[gsm] text-only paraphrase")
